...
<div class="post-featured-image">
        <?php if ( get_theme_mod('portfolio_three_column_image')) { ?>
		<img src="<?php echo esc_url(get_theme_mod('portfolio_three_column_image')); ?>" />
	<?php } else { ?>
                <img src="<?php echo get_template_directory_uri(); ?>/includes/images/slider1.jpg" alt=""/>
        <?php  } ?>
                <div class="blog-content">
                     <?php if ( get_theme_mod('portfolio_three_column_title') !='' ) {  ?><h3><?php echo esc_html(get_theme_mod('portfolio_three_column_title')); ?></h3>

                            <?php } else {  ?> <h1><?php esc_html_e(' Portfolio Three Column Page', 'safari') ?></h1>
                                     <?php } ?>
                            
                            <?php if ( get_theme_mod('portfolio_three_column_description') !='' ) {  ?>
                            <p><?php echo esc_html(get_theme_mod('portfolio_three_column_description')); ?></p>
                                     <?php } else { ?>
